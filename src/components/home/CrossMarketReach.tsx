                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="absolute inset-0 z-10 flex flex-col justify-center bg-black/20" >
                                <h2
                                    className={`font-roboto text-2xl lg:text-5xl font-bold text-white block text-start uppercase pr-[3rem] mb-2 2xl:mb-6 px-6 md:h-16 ${isHovered ? "" : "whitespace-nowrap"}`}
                                    style={{
                                        textShadow:
